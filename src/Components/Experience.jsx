...
function Experience() {
  ...
  <h3 className='text-center text-6xl p-5 italic'>EXPERIENCE</h3>
    ...
    <div class="m-5 ">
  <div class="outline outline-offset-2 outline-pink-500 group mx-2 mt-10 grid max-w-screen-md grid-cols-12 space-x-8 overflow-hidden rounded-lg border py-8 text-gray-700 shadow transition hover:shadow-lg sm:mx-auto">
